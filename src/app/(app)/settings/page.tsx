...
export default function SettingsPage() {
  ...
  const [preferredProvider, setPreferredProvider] = useState<"xai" | "openai">(
    "xai"
  );
    ...
    try {
      ...
      if (data) {
        ...
        setSelectedLanguages(
          data.default_languages.length > 0
  ...
  async function handleSave() {
    ...
    try {
      ...
      const settings: UserSettings = {
        ...
        auto_fill_languages: autoFillLanguages,
    ...
    <div className="mx-auto max-w-3xl space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Configure your API keys, language preferences, and prompt templates.
        </p>
      </div>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <button
                ...
                aria-label={showXai ? "Hide xAI API key" : "Show xAI API key"}
              >
                {showXai ? (
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-3 top-1/2 -translate-y-1/2 text-muted-foreground hover:text-foreground"
                aria-label={showGoogle ? "Hide Google API key" : "Show Google API key"}
              >
                {showGoogle ? (
                  <EyeOff className="size-4" />
                ) : (
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(v) =>
                setPreferredProvider(v as "xai" | "openai")
              }
            >
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Select which languages are pre-checked when translating.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-5">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2 sm:grid-cols-3 md:grid-cols-4">
              {youtubeLanguages.map((lang) => (
                <label
                  key={lang.code}
                  className="flex cursor-pointer items-center gap-2 rounded-md border border-border px-3 py-2 text-sm transition-colors hover:bg-accent/50"
                >
                  <Checkbox
          ...
          <div className="flex items-center gap-3">
            <Switch
              checked={autoFillLanguages}
              onCheckedChange={setAutoFillLanguages}
            />
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Customize the prompts sent to the AI. Use{" "}
            <code className="rounded bg-muted px-1 py-0.5 text-xs">
              [TARGET LANGUAGE]
            </code>{" "}
            as a placeholder in the script prompt.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          {/* Script Prompt */}
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Button
                ...
                onClick={() => setScriptPrompt(DEFAULT_SCRIPT_PROMPT)}
              >
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Button
                ...
                size="sm"
                className="h-7 text-xs"
                onClick={() => setThumbnailPrompt(DEFAULT_THUMBNAIL_PROMPT)}
              >
                <RotateCcw className="size-3 mr-1" />
                Reset
              </Button>
